...
<body id="home" class="scrollspy">
        ...
        <div class="nav-wrapper">
          ...
          <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
           <ul class="right hide-on-med-and-down">
            ...
            <li>
              <a href="patient_records.php">view Patient records</a>
            </li>
            <li>
              <a href="#create_record">Fill Patient record</a>
              </li>
            <li>
  ...
  <section class="slider">
    ...
    <section id="create_record" class="section section-contact scrollspy">
    <div class="container">
      <div class="row">
      <div class="col s12 m6">
        ...
        <div class="col s12 m6">
          ...
          <form method="post" action="doctor.php" >
            ...
            <div class="input-field">
              <textarea class="materialize-textarea" placeholder="Patient Diagnosis" name="diagnosis"></textarea>
              <label for="diagnosis">Diagnosis</label>
  	        </div>
            <div class="input-field">
              <textarea class="materialize-textarea" placeholder="Patient prescription" name="prescription"></textarea>
              <label for="prescription">Prescription</label>
  	        </div>
  	        <div class="input-field">
  	          <button type="submit" class="btn" name="create_record">submit record</button>
            </div>
          </form>
        </div>
      </div>
